    ...
    def fit(
        ...
        for epoch in range(epochs):
            ...
            if (epoch + 1) % eval_interval == 0:
                ...
                logging.info(f"Epoch {epoch+1:3d}/{epochs} | ELBO: {elbo.item():8.2f} | l: [{ls_str}] | var: {params_final['outputscale']:.3f} | noise2: {params_final['noisescale']:3f} | dof_func: {params_final['dof_func']:.2f} | dof_lik: {params_final['dof_lik']:.2f}")
